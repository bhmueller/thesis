...
\begin{abstract}
	...
	This paper assesses the predictive validity of the extended Morris method introduced by \citet{GM17} by applying it to a classical structural econometric model, the single-agent dynamic stochastic model of discrete choice introduced by \citet{R87}. I assess the predictive validity of extended Morris indices by comparing the implied screening and ranking of the inputs to the ones induced by Shapley effects, a now popular sensitivity method. I also compare them according to the uncertainty inherent in their estimation process. Morris indices promise to serve similar purposes as Shapley effects but to come at a lower computational cost, thus encouraging their application in modelling.
