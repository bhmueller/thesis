...
The computation of the extended Morris indices requires the generation of dependent samples. Following \citet{GM17}, the computation involves the following steps:
...
\begin{enumerate}
    ...
    \item As in the case of the classic Morris method, average over all $N$ elementary effects per input $i$ and compute their standard deviation.
\end{enumerate}
...
In what follows I stick to the version of the algorithm as implemented in the \textit{econsa} Python-package \citep{OSE21}. There, the radial design is used for obtaining independent samples. To derive
